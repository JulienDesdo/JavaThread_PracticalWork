...
public class classJframe extends JFrame {
    ...
    public classJframe() {
        	...
        	public void actionPerformed(ActionEvent e) {
        		if (!contentPane.imagesLoaded()) {
                    JOptionPane.showMessageDialog(
                        classJframe.this,
                        "L'image Builder Sign n'est pas charg�e. Veuillez charger l'image avant de d�marrer l'animation.",
                        "Erreur",
        		...
        		if (!constructThread.isAlive()) {
                	...
                	contentPane.setConstructAnimationActive(true); // Activer l'animation, d�sactiver les clics
                }
        		contentPane.repaint();
        ...
        mntmNewMenuItem_6.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		if (!contentPane.imagesLoaded()) {
                    JOptionPane.showMessageDialog(
                        classJframe.this,
                        "L'image Loop n'est pas charg�e. Veuillez charger l'image avant de d�marrer l'animation.",
                        "Erreur",
                        JOptionPane.WARNING_MESSAGE
                    );
                    return;
        ...
        mntmNewMenuItem_7.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		if (!contentPane.imagesLoaded()) {
                    JOptionPane.showMessageDialog(
                        classJframe.this,
                        "L'image Earth n'est pas charg�e. Veuillez charger l'image avant de d�marrer l'animation.",
                        "Erreur",
                        JOptionPane.WARNING_MESSAGE
                    );
                    return;
        ...
        mntmNewMenuItem_8.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		if (!contentPane.imagesLoaded()) {
                    JOptionPane.showMessageDialog(
                        classJframe.this,
                        "L'image Builder Sign n'est pas charg�e. Il n'y a pas d'animation � arr�ter.",
                        "Erreur",
                        JOptionPane.WARNING_MESSAGE
                    );
                    return;
        		...
        		if (constructThread != null && constructThread.isAlive()) {
                    ...
                    contentPane.setConstructAnimationActive(false); // D�sactiver l'animation, activer les clics
                }
        ...
        mntmNewMenuItem_9.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		if (!contentPane.imagesLoaded()) {
                    JOptionPane.showMessageDialog(
                        classJframe.this,
                        "L'image Loop n'est pas charg�e. Il n'y a pas d'animation � arr�ter.",
                        "Erreur",
                        JOptionPane.WARNING_MESSAGE
                    );
                    return;
        ...
        mntmNewMenuItem_10.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		if (!contentPane.imagesLoaded()) {
                    JOptionPane.showMessageDialog(
                        classJframe.this,
                        "L'image Earth n'est pas charg�e. Il n'y a pas d'animation � arr�ter.",
                        "Erreur",
                        JOptionPane.WARNING_MESSAGE
                    );
                    return;
        ...
        setContentPane(contentPane);  // D�finir le contentPane � partir de votre classJpanel
